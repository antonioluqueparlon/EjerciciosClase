...
public class Explosion extends Actor {
	...
	public Explosion(int x, int y) {
		...
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion3.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion4.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion5.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion6.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion7.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion8.png"));
		nuevosSprites.add(CacheRecursos.getInstancia().getImagen("sprite-explosion9.png"));
