...
public class Vehiculo {
	...
	protected int x,y; // Coordenadas en las que se encuentra el vehiculo
	 ...
	 * @param spriteName
	 */
	public Vehiculo (String spriteNames[]) {
	 ...
	 */
	public Vehiculo (String spriteNames[], int velocidadDeCambioDeSprite) {
